...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.time_selector = QtWidgets.QLabel(Form)
        self.time_selector.setObjectName("time_selector")
        self.gridLayout.addWidget(self.time_selector, 0, 0, 1, 1)
        ...
        self.day_selector = QtWidgets.QLabel(Form)
        self.day_selector.setObjectName("day_selector")
        self.gridLayout.addWidget(self.day_selector, 1, 0, 1, 1)
        self.hour_incrementor = QtWidgets.QLineEdit(Form)
        self.hour_incrementor.setObjectName("hour_incrementor")
        self.gridLayout.addWidget(self.hour_incrementor, 0, 3, 1, 1)
        self.minute_incrementor = QtWidgets.QLineEdit(Form)
        self.minute_incrementor.setObjectName("minute_incrementor")
        self.gridLayout.addWidget(self.minute_incrementor, 1, 3, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.time_selector.setText(_translate("Form", "Select time"))
        self.label.setText(_translate("Form", "Hour"))
        self.day_selector.setText(_translate("Form", "select day type"))
